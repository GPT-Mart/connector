...
async function startServer() {
  ...
  const HOST = '0.0.0.0'; // <-- THIS IS THE FIX
  ...
  async function readDB() {
    try {
      ...
      const allGpts = [
        ...
        { title:"Blasphemy -- Holy Heresy,Divine Rebellion", desc:"Explore controversial, sacred, and forbidden ideas — religion, philosophy, truth beyond tradition.", icon:"httpsupload.wikimedia.org/wikipedia/commons/4/41/Blasphemous_logo.png", categories:["Philosophy"], url:"https://chatgpt.com/g/g-68652a058b348191ba363415dda6bf23-blasphemy-holy-heresy-divine-rebellion?model=gpt-4o"},
        ...
        { title:"JavaScript", desc:"Modern JS — ES6+, DOM, async, Node.js. Debugging & best practices.", icon:"httpshttps://upload.wikimedia.org/wikipedia/commons/9/99/Unofficial_JavaScript_logo_2.svg", categories:["Languages","Frontend"], url:"https://chatgpt.com/g/g-67ef55adf8bc8191b0ed342c54a7ffed-javascript"},
        ...
        { title:"StackOverflow Parrot GPT", desc:"The sassiest dev bot alive. Ask it anything and get roasted like you're on StackOverflow...", icon:"https://cdn-icons-png.flaticon.com/512/2926/2926725.png", categories:["Humor","Tools"], url:"httpsS://chatgpt.com/g/g-68dabe58efc88191b7b5340395c98de7-stackoverflow-parrot-gpt?model=gpt-5"},
      ...
      // --- MODIFIED: Added leads: [] to default data ---
